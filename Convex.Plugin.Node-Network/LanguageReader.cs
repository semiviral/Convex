...
namespace Convex.Plugin.Node_Network {
    public class LanguageReader : IPlugin {
        ...
        public async Task Start() {
            ...
            await DoCallback(this, new PluginActionEventArgs(PluginActionType.RegisterMethod, new Composition<ServerMessagedEventArgs>(RegistrarExecutionStep.Step3, ProcessText, args => true, Commands.PRIVMSG, null), Name));
        }
